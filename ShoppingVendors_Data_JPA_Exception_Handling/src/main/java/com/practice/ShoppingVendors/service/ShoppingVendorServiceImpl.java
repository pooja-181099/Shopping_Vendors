...
import com.practice.ShoppingVendors.Exception.ShoppingVendorNotFoundException;
...
public class ShoppingVendorServiceImpl implements ShoppingVendorService{
	...
	public ShoppingVendor getDetailsById(String id) {
		...
		if(!(dao.findById(id).isPresent()))
			throw new ShoppingVendorNotFoundException("Requested Shopping Vendor is not Available");
